...
// Number of infield/battery positions that must always be filled (HR-7).
export const REQUIRED_INFIELD_COUNT = INFIELD_POSITIONS.length;
...
export function getFieldPositions(mode, outfieldCount) {
  return [...INFIELD_POSITIONS, ...getOutfieldPositions(mode, outfieldCount)];
}
